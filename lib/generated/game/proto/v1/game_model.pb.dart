...
class GameModel extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GameModel', package: const $pb.PackageName(_omitMessageNames ? '' : 'game.proto.v1'), createEmptyInstance: create)
    ...
    ..e<GamePlayabilityStatus>(10, _omitFieldNames ? '' : 'playabilityStatus', $pb.PbFieldType.OE, defaultOrMaker: GamePlayabilityStatus.GAME_PLAYABILITY_STATUS_UNKNOWN, valueOf: GamePlayabilityStatus.valueOf, enumValues: GamePlayabilityStatus.values)
    ..e<GameControllerSupport>(11, _omitFieldNames ? '' : 'keyboardMouseSupport', $pb.PbFieldType.OE, defaultOrMaker: GameControllerSupport.GAME_CONTROLLER_SUPPORT_UNKNOWN, valueOf: GameControllerSupport.valueOf, enumValues: GameControllerSupport.values)
    ..e<GameControllerSupport>(12, _omitFieldNames ? '' : 'xboxControllerSupport', $pb.PbFieldType.OE, defaultOrMaker: GameControllerSupport.GAME_CONTROLLER_SUPPORT_UNKNOWN, valueOf: GameControllerSupport.valueOf, enumValues: GameControllerSupport.values)
    ..e<GameControllerSupport>(13, _omitFieldNames ? '' : 'ds4ControllerSupport', $pb.PbFieldType.OE, defaultOrMaker: GameControllerSupport.GAME_CONTROLLER_SUPPORT_UNKNOWN, valueOf: GameControllerSupport.valueOf, enumValues: GameControllerSupport.values)
    ..e<GameControllerSupport>(14, _omitFieldNames ? '' : 'ds5ControllerSupport', $pb.PbFieldType.OE, defaultOrMaker: GameControllerSupport.GAME_CONTROLLER_SUPPORT_UNKNOWN, valueOf: GameControllerSupport.valueOf, enumValues: GameControllerSupport.values)
  ...
  @$pb.TagNumber(10)
  GamePlayabilityStatus get playabilityStatus => $_getN(9);
  @$pb.TagNumber(10)
  set playabilityStatus(GamePlayabilityStatus v) { setField(10, v); }
  @$pb.TagNumber(10)
  $core.bool hasPlayabilityStatus() => $_has(9);
  @$pb.TagNumber(10)
  void clearPlayabilityStatus() => clearField(10);

  @$pb.TagNumber(11)
  GameControllerSupport get keyboardMouseSupport => $_getN(10);
  @$pb.TagNumber(11)
  set keyboardMouseSupport(GameControllerSupport v) { setField(11, v); }
  @$pb.TagNumber(11)
  $core.bool hasKeyboardMouseSupport() => $_has(10);
  @$pb.TagNumber(11)
  void clearKeyboardMouseSupport() => clearField(11);

  @$pb.TagNumber(12)
  GameControllerSupport get xboxControllerSupport => $_getN(11);
  @$pb.TagNumber(12)
  set xboxControllerSupport(GameControllerSupport v) { setField(12, v); }
  @$pb.TagNumber(12)
  $core.bool hasXboxControllerSupport() => $_has(11);
  @$pb.TagNumber(12)
  void clearXboxControllerSupport() => clearField(12);

  @$pb.TagNumber(13)
  GameControllerSupport get ds4ControllerSupport => $_getN(12);
  @$pb.TagNumber(13)
  set ds4ControllerSupport(GameControllerSupport v) { setField(13, v); }
  @$pb.TagNumber(13)
  $core.bool hasDs4ControllerSupport() => $_has(12);
  @$pb.TagNumber(13)
  void clearDs4ControllerSupport() => clearField(13);

  @$pb.TagNumber(14)
  GameControllerSupport get ds5ControllerSupport => $_getN(13);
  @$pb.TagNumber(14)
  set ds5ControllerSupport(GameControllerSupport v) { setField(14, v); }
  @$pb.TagNumber(14)
  $core.bool hasDs5ControllerSupport() => $_has(13);
  @$pb.TagNumber(14)
  void clearDs5ControllerSupport() => clearField(14);
}
